...
<html ng-app="app" ng-controller="testCtrl">
    <head>
        ...
        <link rel="stylesheet" href="../assets/css/huntInProgress.css" />
        ...
        <header>
                    ...
                    <div class="col-xs-12 col-sm-12">
                        <div class="hidden-sm hidden-md hidden-lg" id="navigateur">
                            <div id="navxs" class="col-xs-offset-2 search">
                                ...
                                <a href="controllers/logout.php"><img src="../assets/img/deco.png" width="40" height="40" alt="submit" id="searchButton" /></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <ul class="col-xs-12 hidden-sm hidden-md hidden-lg" id="ul500">
                <div class="row">
                    ...
                    <li id="lienancre11"><a href="pokedexAllGen.php" class="mainTitle" id="subNavTitle" title="pokedex">Pokedex</a></li>
            ...
            <div class="hidden-xs row">
                <div class="col-md-offset-3 col-lg-offset-2 col-lg-8">
                    <div id="subnav">
                        <div class="row">
                            <div class="col-lg-offset-2 col-sm-3 col-md-5 col-lg-3 colNav">
                                <a href="pokedexAllGen.php" class="libelNav"><img class="imgNav" src="../assets/img/pokedex.png"/>Pokedex</a>
                            </div>
                            <div class="col-sm-3 col-md-3 col-lg-3 colNav">
                                <a href="shasseurs.php" class="libelNav"><img src="../assets/img/trade.png"/>Shasseurs</a>
                            </div>
                            <div class="col-sm-3 col-md-3 col-lg-3 colNav">
